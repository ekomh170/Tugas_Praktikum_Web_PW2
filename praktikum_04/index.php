...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Praktikum 04 - Dashboard Website</h1>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Dashboard Website - Eko Muchamad Haryono</h3>
          ...
          <div class="card-body">
            <div class="container">
              <h4 class="text-center mt-4">Selamat Datang Di Aplikasi Website Pengumpulan Tugas Pemrograman Web 2</h4>
          ...
          <div class="card-footer">
            Dashboard Website - Eko Muchamad Haryono
          </div>
          <!-- /.card-footer-->
        </div>
        <!-- /.card -->
