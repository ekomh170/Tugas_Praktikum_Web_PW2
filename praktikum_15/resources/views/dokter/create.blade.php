    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Create New Dokter</h1> <!-- Mengubah judul menjadi "Create New Dokter" -->
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Create New Dokter</li> <!-- Mengubah breadcrumb menjadi "Create New Dokter" -->
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
